<template>
  <div class="weather-widget">
    <div class="cover">
      <img :src="'https://images.pexels.com/photos/844297/pexels-photo-844297.jpeg'" alt="Cover Image" style="width: 100px; height: 100px;">
    </div>
    <h1> Cuaca</h1>
    <div class="location">
  ...
  <footer>
      <p>&copy; 2024 mickodwiseptiandi(223510120). Hak Cipta Dilindungi Undang-Undang.</p>
    </footer>
</template>
...
export default {
  data() {
    return {
      ...
      weatherData: null,
      weatherIconUrl: '',
      apiKey: '1448a4a8998348560ab0abd7482f9030', // Masukkan API key di sini
    };
  },
  methods: {
    async getWeather() {
